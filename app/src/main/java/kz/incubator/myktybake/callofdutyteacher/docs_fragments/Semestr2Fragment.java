...
public class Semestr2Fragment extends Fragment implements View.OnClickListener{
    View view;
    ...
    public void getLessons() {
        ...
        Query myTopPostsQuery = mDatabase.child("personnel_store").child("store").child(emailStr).child("lessons").child("semestr2");
